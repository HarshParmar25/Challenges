...
describe('Get Buy-rent-sold page Url From Data', () => {
	test('Get sale state url', () => {
		const data = Listing.getStateUrlFromData({ saleMethod: 'Sale', state: 'vic' });
	...
	test('Get sale city url', () => {
		const data = Listing.getCityUrlFromData({ saleMethod: 'Sale', state: 'VIC', city: 'Mel/born' });
	...
	test('Get sale region url', () => {
		const data = Listing.getRegionUrlFromData({ saleMethod: 'Sale', state: 'vic', region: 'melborn' });
	...
	test('Get sale suburb url', () => {
		const data = Listing.getSuburbUrlFromData({
			saleMethod: 'Sale',
			state: 'vic',
			suburb: 'richmond',
			postalCode: 1234
	...
	test('Get rent state url', () => {
		const data = Listing.getStateUrlFromData({ saleMethod: 'rent', state: 'vic' });
	...
	test('Get rent city url', () => {
		const data = Listing.getCityUrlFromData({ saleMethod: 'rent', state: 'vic', city: 'melborn' });
	...
	test('Get rent region url', () => {
		const data = Listing.getRegionUrlFromData({ saleMethod: 'rent', state: 'vic', region: 'melborn' });
		const result = `/for-rent/in-vic-melborn/`;
	...
	test('Get sold state url', () => {
		const data = Listing.getStateUrlFromData({ saleMethod: 'sold', state: 'vic' });
	...
	test('Get sold city url', () => {
		const data = Listing.getCityUrlFromData({ saleMethod: 'sold', state: 'vic', city: 'melborn' });
	...
	test('Get sold region url', () => {
		const data = Listing.getRegionUrlFromData({ saleMethod: 'sold', state: 'vic', region: 'melborn' });
		const result = `/sold-properties/in-vic-melborn/`;
	...
	test('Get rent region url', () => {
		const data = Listing.getRegionUrlFromData({
			saleMethod: 'Rent',
			state: 'Nsw',
			region: 'Attunga'
		});
	...
	test('Get sold city url', () => {
		const data = Listing.getCityUrlFromData({
			saleMethod: 'Sold',
			state: 'Vic',
			city: 'Melbourne',
			minPrice: 50000,
...
describe('Get Buy-rent-sold page Data from url', () => {
	test('for-sale/in-vic/', () => {
		const data = Listing.getDataFromUrl(`for-sale/in-vic/`);
		const result = {
			saleMethod: 'Sale',
			state: 'vic'
		};
	...
	test('for-sale/studios-and-townhouses-and-villas-in-vic-richmond-3121-with-1-bedroom-from-50000/', () => {
		const data = Listing.getDataFromUrl(
	...
	test('for-rent/in-wa-city-beach-6015-from-150-per-week/', () => {
		const data = Listing.getDataFromUrl(`for-rent/in-wa-city-beach-6015-from-150-per-week/`);
		const result = {
			saleMethod: 'Rent',
			state: 'wa',
			suburb: 'City Beach',
	...
	test('for-rent/in-nsw-attunga/', () => {
		const data = Listing.getDataFromUrl(`for-rent/in-nsw-attunga/`);
		const result = {
			saleMethod: 'Rent',
			state: 'nsw',
			region: 'Attunga'
...
////////////////////////////////////////////////////////////
describe('Search page details according to state/city/region/suburb', () => {
	test('for-sale/studios-and-townhouses-and-villas-in-vic-richmond-3121-with-1-bedroom-from-50000/', () => {
		const data = Listing.getDataFromSuburbUrl(
			`for-sale/studios-and-townhouses-and-villas-in-vic-richmond-3121-with-1-bedroom-from-50000/`
		);
		const result = {
			saleMethod: 'Sale',
	...
	test('for-sale/in-vic/', () => {
		const data = Listing.getDataFromStateUrl(`for-sale/in-vic/`);
		const result = {
			saleMethod: 'Sale',
			state: 'vic'
		};
	...
	test('sold-properties/houses-and-units-and-apartments-and-studios-and-townhouses-and-land-and-villas-and-rural-in-vic-melbourne-with-3-bedrooms-between-50000-and-75000/', () => {
		const data = Listing.getDataFromCityUrl(
			`/sold-properties/houses-and-units-and-apartments-and-studios-and-townhouses-and-land-and-villas-and-rural-in-vic-melbourne-with-3-bedrooms-between-50000-and-75000/`
		);
		const result = {
			saleMethod: 'Sold',
	...
	test('for-rent/in-wa-city-beach-6015-from-150-per-week/', () => {
		const data = Listing.getDataFromSuburbUrl(`for-rent/in-wa-city-beach-6015-from-150-per-week/`);
		const result = {
			saleMethod: 'Rent',
			state: 'wa',
			suburb: 'City Beach',
	...
	test('for-rent/in-nsw-attunga/', () => {
		const data = Listing.getDataFromRegionUrl(`for-rent/in-nsw-attunga/`);
		const result = {
			saleMethod: 'Rent',
			state: 'nsw',
			region: 'Attunga'
	...
	test('for-sale/studios-and-townhouses-and-villas-in-vic-inner-west-with-1-bedroom-up-to-75000/', () => {
		const data = Listing.getDataFromRegionUrl(
			`for-sale/studios-and-townhouses-and-villas-in-vic-inner-west-with-1-bedroom-up-to-75000/`
		);
		const result = {
			saleMethod: 'Sale',
